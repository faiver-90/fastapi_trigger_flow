...
@v1_trigger_router.post(
    "/", response_model=TriggerOut, dependencies=[Depends(verify_superuser)],
...
@v1_trigger_router.get(
    "/{item_id}", response_model=TriggerOut, dependencies=[Depends(verify_superuser)],
...
@v1_trigger_router.delete(
    "/{item_id}", dependencies=[Depends(verify_superuser)],
